...
import { Patient, Appointment, SoapNote, AppointmentStatus, TreatmentPlan, ExercisePrescription, AuditLogEntry, Therapist, AppointmentType, RecurrenceRule, KnowledgeBaseEntry, User, Role, PainLog, Exercise, Group, VoucherPlan, Voucher, Document, Task, TaskStatus, TaskPriority, Notification, PatientAttachment } from '../types';
...
export const mockPatients: Patient[] = [
  {
    ...
    conditions: ['Gonalgia D por condropatia patelar'],
    attachments: [
  ...
  },
  {
    ...
    consentGiven: true,
    conditions: ['Fascite Plantar Crônica'],
  },
  {
    id: '6',
    name: 'Lúcia Martins',
    ...
    consentGiven: true,
    conditions: ['Cervicalgia por tensão postural'],
  ...
  },
  {
    ...
    conditions: ['Pós-operatório de ATQ E'],
  },
  {
    id: '8',
    name: 'Júlia Pereira',
    ...
    conditions: ['Pós-operatório de LCA D - Retorno ao esporte'],
  },
];
...
export const mockAppointments: Appointment[] = [
    { id: 'app1', patientId: '1', patientName: 'Ana Beatriz Costa', therapistId: 'therapist_1', startTime: getFutureDate(0, 9), endTime: getFutureDate(0, 10), title: 'Avaliação de joelho', type: AppointmentType.Evaluation, status: AppointmentStatus.Scheduled, value: 150, paymentStatus: 'pending', sessionNumber: 1, totalSessions: 10 },
    { id: 'app2', patientId: '2', patientName: 'Bruno Gomes', therapistId: 'therapist_2', startTime: getFutureDate(0, 10), endTime: getFutureDate(0, 11), title: 'Tratamento de lombar', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending', sessionNumber: 3, totalSessions: 8 },
    { id: 'app3', patientId: '1', patientName: 'Ana Beatriz Costa', therapistId: 'therapist_1', startTime: getFutureDate(1, 14), endTime: getFutureDate(1, 15), title: 'Sessão de fortalecimento', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending', sessionNumber: 2, totalSessions: 10 },
    { id: 'app4', patientId: '3', patientName: 'Carla Dias', therapistId: 'therapist_3', startTime: getFutureDate(2, 11), endTime: getFutureDate(2, 12), title: 'Consulta de retorno', type: AppointmentType.Return, status: AppointmentStatus.Scheduled, value: 100, paymentStatus: 'paid' },
    { id: 'app5', patientId: '2', patientName: 'Bruno Gomes', therapistId: 'therapist_2', startTime: getFutureDate(4, 9), endTime: getFutureDate(4, 10), title: 'Sessão de acompanhamento', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending', sessionNumber: 4, totalSessions: 8 },
    { id: 'app6', patientId: '4', patientName: 'Daniel Almeida', therapistId: 'therapist_1', startTime: getFutureDate(-1, 11), endTime: getFutureDate(-1, 11, 30), title: 'Pós-alta', type: AppointmentType.Return, status: AppointmentStatus.Completed, value: 80, paymentStatus: 'paid' },
    { id: 'app7', patientId: '1', patientName: 'Ana Beatriz Costa', therapistId: 'therapist_1', startTime: getFutureDate(-2, 9), endTime: getFutureDate(-2, 10), title: 'Avaliação de joelho', type: AppointmentType.Evaluation, status: AppointmentStatus.Completed, value: 150, paymentStatus: 'paid' },
    { id: 'app8', patientId: '2', patientName: 'Bruno Gomes', therapistId: 'therapist_2', startTime: getFutureDate(-3, 10), endTime: getFutureDate(-3, 11), title: 'Tratamento de lombar', type: AppointmentType.Session, status: AppointmentStatus.Completed, value: 120, paymentStatus: 'paid' },
    { id: 'app9', patientId: '3', patientName: 'Carla Dias', therapistId: 'therapist_2', startTime: getFutureDate(-4, 14), endTime: getFutureDate(-4, 15), title: 'Sessão', type: AppointmentType.Session, status: AppointmentStatus.Completed, value: 120, paymentStatus: 'paid' },
    { id: 'app10', patientId: '5', patientName: 'Fernando Oliveira', therapistId: 'therapist_2', startTime: getFutureDate(0, 11), endTime: getFutureDate(0, 12), title: 'Fascite Plantar', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'paid' },
    { id: 'app11', patientId: '6', patientName: 'Lúcia Martins', therapistId: 'therapist_3', startTime: getFutureDate(1, 10), endTime: getFutureDate(1, 11), title: 'Cervicalgia', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending' },
    { id: 'app12', patientId: '7', patientName: 'Mário Santos', therapistId: 'therapist_1', startTime: getFutureDate(1, 16), endTime: getFutureDate(1, 17), title: 'Pós-op Quadril', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'paid' },
    { id: 'app13', patientId: '8', patientName: 'Júlia Pereira', therapistId: 'therapist_1', startTime: getFutureDate(2, 15), endTime: getFutureDate(2, 16), title: 'Pós-op LCA', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending' },
    { id: 'app14', patientId: '5', patientName: 'Fernando Oliveira', therapistId: 'therapist_2', startTime: getFutureDate(-3, 11), endTime: getFutureDate(-3, 12), title: 'Fascite Plantar', type: AppointmentType.Session, status: AppointmentStatus.Completed, value: 120, paymentStatus: 'paid' },
...
export const mockSoapNotes: SoapNote[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    bodyParts: ['Costas (Lombar)', 'Perna Esquerda'],
    painScale: 8,
  },
  {
    id: 'note4',
...
export const mockExercises: Exercise[] = [
  {
    ...
    media: {
      thumbnailUrl: 'https://img.youtube.com/vi/44mgUselcDU/0.jpg',
  ...
  },
  {
    ...
    media: {
      thumbnailUrl: 'https://img.youtube.com/vi/UXrOiF_b8dE/0.jpg',
      videoUrl: 'https://www.youtube.com/watch?v=UXrOiF_b8dE'
    },
    modifications: {
  ...
  },
  {
    ...
    media: {
      thumbnailUrl: 'https://img.youtube.com/vi/ke_yE-o4s-A/0.jpg',
      videoUrl: 'https://www.youtube.com/watch?v=ke_yE-o4s-A'
    }
  }
];
