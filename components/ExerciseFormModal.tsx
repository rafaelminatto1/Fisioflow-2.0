...
const ExerciseFormModal: React.FC<ExerciseFormModalProps> = ({ isOpen, onClose, onSave, exerciseToEdit, saveAsSuggestion = false }) => {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            ...
            const submissionData: Omit<Exercise, 'id'> = {
                ...formData,
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="category" value={formData.category} onChange={handleChange} className="mt-1 w-full p-2 border border-slate-300 rounded-lg bg-white">
                                <option>Fortalecimento</option><option>Alongamento</option><option>Mobilidade</option><option>Propriocepção</option><option>Cardio</option>
                            </select>
                        </div>
                    </div>
                    <div>
