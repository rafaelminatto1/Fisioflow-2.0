                                ...
                                <li key={app.id} className="relative">
                                    ...
                                    <div className="ml-8">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-xs font-semibold px-2 py-0.5 rounded-full text-white" style={{backgroundColor: statusInfo.color.replace('bg-','').replace('-500','')}}>{statusInfo.label}</span>
                                        </div>
