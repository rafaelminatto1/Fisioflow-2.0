...
describe('PatientListPage', () => {
  ...
  it('deve renderizar a lista de pacientes quando os dados são carregados', () => {
    const mockData: Patient[] = [
      { id: '1', name: 'Ana Beatriz Costa', cpf: '111', email: 'ana@email.com', phone: '123', status: 'Active', lastVisit: new Date().toISOString(), avatarUrl: '' , birthDate: '', emergencyContact: {name: '', phone:''}, address: { street: '', city: '', state: '', zip: ''}, consentGiven: true, registrationDate: '2023-10-01' },
      { id: '2', name: 'Bruno Gomes', cpf: '222', email: 'bruno@email.com', phone: '456', status: 'Inactive', lastVisit: new Date().toISOString(), avatarUrl: '', birthDate: '', emergencyContact: {name: '', phone:''}, address: { street: '', city: '', state: '', zip: ''}, consentGiven: true, registrationDate: '2023-10-02' },
    ];
